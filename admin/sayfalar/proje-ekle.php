...
<!-- Main content -->
 ...
 <div class="col-sm-12">
                      <div class="form-group">
                        <label>Başlık</label>
                        <input type="text" name="proje_name" class="form-control" placeholder="Proje Başlık">
                      </div>
                    </div>
             <div class="col-sm-12">
                      <div class="form-group">
                        <label>Etiket</label>
                        <input type="text" name="proje_etiket" class="form-control" placeholder="etiket">
                      </div>
                    </div>
              ...
              <div align="left" class="col-sm-1">
                <button type="submit" name="projeekle" class="btn btn-success">Ekle</button>
              </div>
            </div>
