...
<!-- Main content -->
 ...
 <div class="col-sm-12">
                      <div class="form-group">
                        ...
                        <input type="text" name="ilgi_ad" class="form-control" placeholder="İlgi Alanın">
                      </div>
                    </div>
                    <div class="col-sm-12">
                      <div  class="form-group">
                        ...
                        <input type="text"  name="ilgi_fa" class="form-control" placeholder="Örn: fas fa-music | Font Awesome 5">
                      </div>
                    </div>
              ...
              <div align="left" class="col-sm-1">
                <button type="submit" name="ilgiekle" class="btn btn-success">Ekle</button>
              </div>
            </div>
